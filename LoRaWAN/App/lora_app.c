...
void ImportGPSobject(sensor_t *sensor){
	GPS_sensor = *sensor;
}

void ImportStatus(int8_t *stat){
	statusDevice = *stat;
}
...
static void SendTxData(void)
{
  ...
  sensor_t sensor_data = GPS_sensor;
  ...
  if (LmHandlerIsBusy() == false)
  {
    ...
    else
    {
      ...
      AppData.Buffer[i++] = (uint8_t)((statusDevice >> 4) & 0xFF);
      AppData.Buffer[i++] = (uint8_t)(statusDevice & 0xFF);
